import { __exports as c } from "../../../../../_virtual/index.min4.js";
var h;
function T() {
  if (h) return c;
  h = 1, Object.defineProperty(c, "__esModule", { value: !0 }), c.parse = b, c.serialize = v;
  const y = /^[\u0021-\u003A\u003C\u003E-\u007E]+$/, w = /^[\u0021-\u003A\u003C-\u007E]*$/, g = /^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i, S = /^[\u0020-\u003A\u003D-\u007E]*$/, E = Object.prototype.toString, p = /* @__PURE__ */ (() => {
    const r = function() {
    };
    return r.prototype = /* @__PURE__ */ Object.create(null), r;
  })();
  function b(r, i) {
    const e = new p(), a = r.length;
    if (a < 2)
      return e;
    const u = (i == null ? void 0 : i.decode) || I;
    let t = 0;
    do {
      const n = r.indexOf("=", t);
      if (n === -1)
        break;
      const l = r.indexOf(";", t), d = l === -1 ? a : l;
      if (n > d) {
        t = r.lastIndexOf(";", n - 1) + 1;
        continue;
      }
      const s = o(r, t, n), $ = f(r, n, s), x = r.slice(s, $);
      if (e[x] === void 0) {
        let m = o(r, n + 1, d), A = f(r, d, m);
        const O = u(r.slice(m, A));
        e[x] = O;
      }
      t = d + 1;
    } while (t < a);
  ...
  function v(r, i, e) {
    ...
    if (e.expires) {
      if (!k(e.expires) || !Number.isFinite(e.expires.valueOf()))
