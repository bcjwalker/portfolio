...
export const projectDataRaw = [
  ...
  // 0: Studbud
  {
    ...
    // Lead card info
    collabs: 'none',
    roles: ['UI/UX design', 'Front-end webdev'],
    software: ['Visual Studio', 'Node.js'],
    timeline: ['~2', 'months'],
  },
  // 1: Convey
  {
    ...
    roles: ['User research', 'UI/UX design', 'Report writing', 'Video production'],
    software: ['Figma', 'Adobe Xd', 'Material 3'],
    timeline: ['~3', 'months'],
  ...
  // 2: Biodiversity article
  {
    ...
    // Lead card info
    collabs: 'none',
    roles: ['Data visualisation', 'UI/UX design', 'Front end webdev'],
    software: ['Visual Studio', 'Node.js', 'Plotly.js'],
    timeline: ['~3', 'months'],
  },
  // 3: Sunstop
  {
    ...
    descFull:
      'A holistic solution to promote sun safety in young Australian men through interactive sunscreen kiosks — promoting sunscreen as a habit through ubiquity, convenience and rewards.',
    descFull2:
      'My personal touch was in pushing for increased visual expression in the use of colour, form and motion in the interface.',
    links: {
      interface: {
        type: 'prmry',
    ...
    roles: ['User research', 'UI/UX design', 'Full stack webdev', 'Report writing'],
    software: ['Figma', 'Visual Studio', 'React.js', 'Node.js'],
    timeline: ['~3', 'months'],
  },
]
