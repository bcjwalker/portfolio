...
function VideoPlayerCard( {children, margins, id, audio, type, caption, title} ) {
    ...
    return (
        ...
        {isDesktop ? 
        <VideoPlayerDesktop margins={margins} id={id} audio={audio} type={type} caption={caption} title={title}> 
            {children}
        </VideoPlayerDesktop>
        : 
        <VideoPlayerMobile margins={margins} id={id} audio={audio} type={type} caption={caption} title={title}>
            {children}
        </VideoPlayerMobile>}
        </Fade>
        </>
            ...
            <div className={`${styles['video-card-container']}`}>
                ...
                <div className={styles['footer-container']}>
                    ...
                    <div className={styles['buttons-wrapper']}>
                        ...
                        {audio ? 
                            <button className={`icon-btn outline-btn outline-1 ${styles[`btn-audio`]}`} onClick={handleAudioClick}>
