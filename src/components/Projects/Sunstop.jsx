        ...
        <section className={`projects-body-section`} id={styles['section1']}>  
            ...
            <div className='body-two-col extra-margins'>
                <div className='col-left'>
                    ...
                    <p className='text-margins'> One of our first tasks in designing the kiosk was to work out how users would choose sunscreen amounts, depending on the situation. We came up with an elegant solution, with <strong>presets based on how much skin is covered by ones' outfit</strong>. To enhance user freedom, we also included the option to dispense extra sunscreen at the end of the flow:</p>
                </div>
                <div className='col-right'>
                    <blockquote className='col-right'>
                        <span className={`material-symbols-sharp quote-glyph`}> format_quote </span>
                        <span className='quote-text desc'>My team and I decided to focus on <strong>how the sunscreen experience could be reframed</strong></span>
                    </blockquote>
                </div>
            </div>

            <VideoPlayerCard margins='text-margins' title='Dispense flow' id='vid-signup' audio={false} type='no-bg-no-radius' caption='Dispense flow: users pick how much sunscreen they get by picking an outfit, which corresponds to how many limbs are covered'>
            <source src={projectMedia[`/src/assets/projects/sunstop/vid-dispense.mp4`]} type="video/mp4"/>
            </VideoPlayerCard>

            <p className='text-margins'>Given the transient nature of the Sunstop experience — each kiosk is its own device — we went back and forth on how to best verify that a user is actually in front of a machine. In the end, we decided that a standard <strong>two-factor authentication login/signup</strong> was best suited for user needs.</p>

            <VideoPlayerCard margins='text-margins' id='vid-signup' audio={false} type='no-bg-no-radius' caption='Onboarding flow: new users instantly get free sunscreen after joining, paving the way for the first reward'>
            ...
            <p className='text-margins'> To provide a hook and incentive for building a sun protection habit, we implemented a <strong>rewards system to encourage continued use</strong>. By dispensing sunscreen, users accumulate points along a score tracker, building towards a set of rewards.</p>
            ...
            <p className='text-margins'> Sadly, for reasons of time, we were only able to finalise a set of mockup rewards, in lieu of a fully comprehensive, market-driven reward service. We had a few ideas for a final design that weren't able to be completed, such as:</p> 
            <ul className='text-margins'>
                <li><strong>Franchise Sunstop kiosks</strong> for external organisations, who could implement targeted rewards for their specific target users;</li>
                <li><strong>A rotating set of rewards</strong> that would change throughout the year, potentially giving the service a sense of <strong>FOMO</strong>;</li>
                <li>And <strong>seasonal collaborations</strong> with popular brands, possibly featuring coupons as rewards.</li>
            </ul>

            <h3 className='article-h3 text-margins'>Marketing campaign</h3>
            <p className='text-margins'>We also considered the market entry for Sunstop developing the accompanying <strong>'Don't be macho about sunscreen'</strong> advertisement campaign. While I didn't have too much involvement with this side of the project, I was able to provide some feedback as a member of the target audience.</p>
            ...
            <figure className={`media-container gallery-3 extra-margins ${styles['section1c-media-gallery']}`}>
                <figure className='media-wrapper lead' id={styles['section1c-lead']}>
                    <div className='img-wrapper bordered' id={styles['wrapper']}>
                        <ImgViewer classN={`${styles['img1']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/insitu/concept-1.jpg']}/>
                    </div>
                </figure>
                <div className='side-media-wrapper'>
                    <figure className='media-wrapper side-1' id={styles['section1c-side-1']}>
                        <div className='img-wrapper bordered' id={styles['section1c-side-1-wrapper']}>
                            <ImgViewer classN={`${styles['img2']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/insitu/concept-2.jpg']}/>
                        </div>
                    </figure>
                    <figure className='media-wrapper side-2' id={styles['section1c-side-2']}>
                        <div className='img-wrapper bordered' id={styles['section1c-side-2-wrapper']}>
                            <ImgViewer classN={`${styles['img3']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/insitu/concept-4.jpg']}/>
                        </div>
                    </figure>
                </div>
                <figcaption>A sample of pages I wrote, and a styleguide I developed for the team to use</figcaption>
            </figure> 
            </Fade>
        </section>
        </>
...
function MainSection_Comparisons(props) {
    ...
    // First comparison
    const compAitem1 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-verif-before.png"]} alt="Image one" /> )}
    const compAitem2 = () => { return (
        <video className='compare-media' autoPlay={true} loop muted>
        <source src={projectMedia["/src/assets/projects/sunstop/vid-verif-loop02.mp4"]} type="video/mp4"/> Your browser does not support the video tag. </video> )}
    // Second comparison
    const compBitem1 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-landing-before.png"]} alt="Image one" />)}
    const compBitem2 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-landing.png"]} alt="Image one" /> )}
    // Third comparison
    const compCitem1 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-login-before.png"]} alt="Image one" /> )}
    const compCitem2 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-login.png"]} alt="Image two" />)}
    // Fourth comparison
    const compDitem1 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-home-before.png"]} alt="Image one" /> )}
    const compDitem2 = () => { return (
        <img className='compare-media' loading="lazy" src={projectMedia["/src/assets/projects/sunstop/screens/screen-home-redeem.png"]} alt="Image two" />)}
    ...
    return (
        ...
        <section className={`projects-body-section`} id={styles['section2']}>
            ...
            <p className='text-margins'> At one point late in prototyping, visual changes on the app slowed to a crawl. So I led a push to <strong>boost Sunstop's visual expression</strong> as well as <strong>generally improving user control, clarity of copy and visibility of system status</strong>. </p>
            <p className='text-margins'> Below are some before/after comparisons to demonstrate the visual changes I singlehandedly oversaw. It seems like a lot of work for one person, but every difference between these two iterations was done <strong>solely</strong> by me:</p>
        
            <CompCard 
                compA={[projectMedia["/src/assets/projects/sunstop/screens/screen-landing.png"], compBitem1, compBitem2,
                ...
                compB={[projectMedia["/src/assets/projects/sunstop/screens/screen-login.png"], compCitem1, compCitem2,
                ...
                compC={[projectMedia["/src/assets/projects/sunstop/screens/screen-verif.png"], compAitem1, compAitem2,
                ...
                compD={[projectMedia["/src/assets/projects/sunstop/screens/screen-home-redeem.png"], compDitem1, compDitem2,
                    "Home page: made buttons more interesting; added flavour text to congratulate user; scaled up progress tracker for clarity"]}/>

            <p className='text-margins'> As seen above, I also added a user profile button, helping to communicate login state and serve as a hub for user-related interactions. Up to this point, there had not actually been a way to modify user details, a major issue for user control and freedom. </p>
            ...
            <div className={`${styles['section2b-media-double']}`}>
                <div className={`${styles['double-media']} media-container double extra-margins`}>
                    <figure className={`${styles['lead']} media-wrapper`}>
                        <div className={`img-wrapper bordered ${styles['img1-wrapper']}`}>
                            <ImgViewer classN={`${styles['img1']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/screens/screen-home-profile.png']}/>
                        </div>
                        <figcaption>Home page featuring new profile button I added, w/ menu open</figcaption>
                    </figure>
                    <figure className={`${styles['side']} media-wrapper nowrap`}>
                        <div className={`img-wrapper bordered ${styles['img2-wrapper']}`}>
                            <ImgViewer classN={`${styles['img2']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/screens/screen-home-profile-open.png']}/>
                        </div>
            ...
            <p className='text-margins'> In addition to redesigning much of the interface, I also oversaw the design and layout of each visual report we submitted. We had a limited page count, so I put together a composition that emphasised information density, while also providing enough whitespace for readability. </p>
            ...
            <figure className={`media-container gallery-3 extra-margins ${styles['section2c-media-gallery']}`}>
                <figure className='media-wrapper lead' id={styles['section2-lead']}>
                    <div className='img-wrapper bordered' id={styles['lead-wrapper']}>
                        <ImgViewer classN={`${styles['img1']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/report/report-page1.jpg']}/>
                    </div>
                </figure>
                <div className='side-media-wrapper'>
                    <figure className='media-wrapper side-1'>
                        <div className='img-wrapper bordered' id={styles['side-1-wrapper']}>
                            <ImgViewer classN={`${styles['img2']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/report/report-page2.jpg']}/>
                        </div>
                    </figure>
                    <figure className='media-wrapper side-2'>
                        <div className='img-wrapper bordered' id={styles['side-2-wrapper']}>
                            <ImgViewer classN={`${styles['img3']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/report/report-guide.jpg']}/>
                        </div>
                    </figure>
                </div>
                <figcaption>A sample of pages I wrote, and a styleguide I developed for the team to use</figcaption>
        ...
        <section className={`projects-body-section ${styles['section4']}`}>
            ...
            <div className='details-wrapper extra-margins insights-wrapper'>
                <div className='details-row-wrapper extra-margins'>
                    <Details_Static title='Convenience and sensory experiences are critical' type='insight-card' colour='prmry'>
                        <p className='details-content'>Young men are more likely to use sunscreen if it is easy to apply, feels good on the skin, and aligns with a desire for convenience.</p>
                        <p className='details-content'><strong>Reframe:</strong> this doesn't necessarily have to refer to sensory experience, it perhaps could feel more natural by becoming a regular, unchanging habit, something users don't have to think much about</p>
                    </Details_Static>
                    <Details_Static title='Social influence plays a major role in sun safety' type='insight-card' colour='prmry'>
                        <p className='details-content'>The behaviors and attitudes of peers significantly impact whether young men use sunscreen. This suggests a strong social component — social norms and peer pressure can either positively or negatively influence sun protection behaviors.</p>
                        <p className='details-content'>If sunscreen use is normalised and seen as a shared practice among friends, young men are more likely to adopt it.</p>
                    </Details_Static>
                </div>
                <Details title='Knowledge gaps and a lack of awareness are barriers to good habits' type='insight-card' colour='scndry' >
                    <p className='details-content'>There is a lack of awareness and understanding about the importance of sun protection as well as the consequences of sun exposure among young men. This knowledge gap directly impacts their sun safety practices.</p>
                    <p className='details-content'>For example, young men who are aware of statistics of sun cancer say that they are more inclined to practice sun safety.</p>
                </Details>
                <Details title='Personal experiences with sun exposure is a motivator for forming good sun protection habits' type='insight-card' colour='scndry' >
                    <p className='details-content'>Personal experiences & values, such as past sunburns, knowing someone affected by skin cancer, not wanting to age increases the motivation of young men to adopt sun protection habits.</p>
                    <p className='details-content'>How can we get people to care about sun exposure if they haven't personally had any strong experiences?</p>
                </Details>
            </div>
            ...
            <div className='body-two-col extra-margins'>
                <div className='col-left'>
                    ...
                    <p className='text-margins details-content'>I found a promising avenue in the use of <strong>gamification</strong>, particularly in rewards-for-exercise apps, which had been proven to increase user engagement and encourage healthy habits. This was the piece of research that eventually led to Sunstop's rewards system.</p>
                </div>
                <div className='col-right'>
                    <blockquote className='col-right'>
                        <span className={`material-symbols-sharp quote-glyph`}> format_quote </span>
...
function MainSection_Grad(props) {
    return (
        ...
        <section className={`projects-body-section ${styles['section5']}`}>   
            <h2 className='article-h2' id={`sunstop-section${props.num}`}>Epilogue: the grad show</h2>
            <p className='text-margins'> For final-year uni students studying in the Faculty of Architecture/Design, a grad show for final projects was put on in December of 2024. Finalising the kiosk prototype and putting together some showcase assets, my team made a really great booth to show off Sunstop. </p>
            <p className='text-margins'> While we didn't win any awards at the show amongst tough competition, we had the honour of getting the <strong>highest mark in our class</strong>, the web design cohort. </p>
            <p className='text-margins'> Overall, I felt incredibly happy with this project. It was a fitting end for my degree, and I think the results speak for themselves. </p>
            ...
            <figure className={`media-container gallery-3 extra-margins ${styles['section5a-media-gallery']}`}>
                <figure className='media-wrapper lead' id={styles['section5-lead']}>
                    <div className='img-wrapper bordered' id={styles['lead-wrapper']}>
                        <ImgViewer classN={`${styles['img1']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/grad/poster.png']}/>
                    </div>
                </figure>
                <div className='side-media-wrapper'>
                    <figure className='media-wrapper side-1' id={styles['section5a-side-1']}>
                        <div className='img-wrapper bordered' id={styles['side-1-wrapper']}>
                            <ImgViewer classN={`${styles['img2']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/grad/final-build-cropped.jpg']}/>
                        </div>
                    </figure>
                    <figure className='media-wrapper side-2' id={styles['section5a-side-2']}>
                        <div className='img-wrapper bordered' id={styles['side-2-wrapper']}>
                            <ImgViewer classN={`${styles['img3']}`} imgSrc={projectMedia['/src/assets/projects/sunstop/grad/family.jpg']}/>
                        </div>
                    </figure>
                </div>
                <figcaption> The poster created for our grad booth; the grad booth; and me with my parents </figcaption>
            </figure> 
            </Fade>
        </section>
        </>
...
function MainSection_Skills(props) {
    return (
        ...
        <section className={`projects-body-section ${styles['section3']}`}>
            ...
            <p className='text-margins'>Despite having to rapidly learn these new frameworks, I quickly brought some of my design skills up to a more modern standard, and I was able to become a leading force in the project.</p>
        </section>
        </>
    )
}
